...
//Room_Create_Controll
 ...
 //Sphere_Big_Controll
	...
	vec3 tetr_center = vec3(2.0, -2.5, 2.5);

	tetr[0].v1 = vec3(tetr_center.x - 2, tetr_center.y, tetr_center.z);
	tetr[0].v2 = vec3(tetr_center.x + 2, tetr_center.y, tetr_center.z);
	tetr[0].v3 = vec3(tetr_center.x, tetr_center.y, tetr_center.z - 3);
	tetr[0].MaterialIdx = 0;

	tetr[1].v1 = vec3(tetr_center.x - 2, tetr_center.y, tetr_center.z);
	tetr[1].v2 = vec3(tetr_center.x + 2, tetr_center.y, tetr_center.z);
	tetr[1].v3 = vec3(tetr_center.x, tetr_center.y + 3, tetr_center.z - 1);
	tetr[1].MaterialIdx = 0;

	tetr[2].v1 = vec3(tetr_center.x - 2, tetr_center.y, tetr_center.z);
	tetr[2].v2 = vec3(tetr_center.x, tetr_center.y, tetr_center.z - 3);
	tetr[2].v3 = vec3(tetr_center.x, tetr_center.y + 3, tetr_center.z - 1);
	tetr[2].MaterialIdx = 0;

	tetr[3].v1 = vec3(tetr_center.x + 2, tetr_center.y, tetr_center.z);
	tetr[3].v2 = vec3(tetr_center.x, tetr_center.y + 3, tetr_center.z - 1);
	tetr[3].v3 = vec3(tetr_center.x, tetr_center.y, tetr_center.z - 3);
...
//Material_Controll
    vec4 lightCoefs = vec4(1.0,0.9,0.0,512.0);    
